...
async def get_dashboard_read_model(
    ...
    return await _load_dashboard(principal, session, as_of=as_of)
...
async def get_current_status_read_model(
    ...
    dashboard = await _load_dashboard(principal, session, as_of=as_of)
...
async def get_next_shifts_read_model(
    ...
    dashboard = await _load_dashboard(principal, session, as_of=as_of, next_shift_limit=limit)
