...
def test_cors_multiple_origins():
    ...
    origins = get_cors_origins("http://localhost:5173,http://localhost:3000,https://example.com", "development")
...
def test_cors_origins_with_spaces():
    ...
    origins = get_cors_origins("http://localhost:5173 , http://localhost:3000 , https://example.com", "production")
    assert origins == ["http://localhost:5173", "http://localhost:3000", "https://example.com"]
