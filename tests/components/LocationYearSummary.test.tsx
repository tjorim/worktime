...
const HOME_NL = { location: "home" as const, countryCode: "NL" };
const OFFICE_BE = { location: "office" as const, countryCode: "BE" };
const OTHER_DE = { location: "other" as const, countryCode: "DE", label: "Berlin office" };
