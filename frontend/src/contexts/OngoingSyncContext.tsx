 ...
 * `<HdayHelperProvider>`, and `<ToastProvider>` is required because it
 * calls `useAuth()`, `useApiClient()` (which depends on
 * `<HdayHelperProvider>` and `<ToastProvider>`).
 *
 ...
 *
 * Must be rendered inside `<AuthProvider>`, `<HdayHelperProvider>`,
